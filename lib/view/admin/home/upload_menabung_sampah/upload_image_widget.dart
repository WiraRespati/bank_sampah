...
class UploadImageWidget extends StatelessWidget {
  ...
  final MenabungSampahController menabungController = Get.put(
          ...
          GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  Get.back();
                                  menabungController.onCameraView();
                                },
                                child: Padding(
                                  padding: const EdgeInsets.only(
                              ...
                              InkWell(
                                onTap: () {
                                  Get.back();
                                  menabungController.onGalleryView();
                                },
                                child: Padding(
                                  padding: const EdgeInsets.only(
            ...
            child: Obx(
              () => Container(
                ...
                height: 324,
                width: 324,
                child: menabungController.imageFile.value != null
                    ? Image.file(
                        File(menabungController.imageFile.value!.path),
                        fit: BoxFit.cover,
                      )
                    : Center(
                        child: Icon(
